...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/slimmenu/css/slimmenu.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/custom_css/horizontal_menu.css
')}}">
...
<body class="skin-default">
    ...
    <script src="{{asset('js/slimmenu/js/jquery.slimmenu.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('js/custom_js/horizontal_menu.js')}}" type="text/javascript"></script>
